...
import TaskListDetails from "app/entities/task/task.list.details";
      ...
      <h2 id="task-heading" data-cy="TaskHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="sqlverifierApp.task.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/task/new" className="btn btn-primary jh-create-entity" id="jh-create-entity"
                data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus"/>
            &nbsp;
            <Translate contentKey="sqlverifierApp.task.home.createLabel">Create new Task</Translate>
          </Link>
        </div>
      </h2>
