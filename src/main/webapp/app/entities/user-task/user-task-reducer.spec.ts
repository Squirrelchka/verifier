...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERTASK_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERTASK actions', async () => {
      const expectedActions = [
        {
